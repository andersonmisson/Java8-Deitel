...
public class MaximumFinder {
	...
	public static void main(String[] args) {
		...
		double number3 = input.nextDouble(); // lê o terceito double
	...
	// retorna o máximo dos seus três parâmentros de double
	public static double maximum(double x, double y, double z) {
		double maximumValue = x; // supoe que x é o maior valor inicial
		
		// determina se y é marior que maximumValue
		if (y > maximumValue)
			maximumValue = y;
		
		// determina se Z é o maior que maximumValue
		if (z > maximumValue)
			maximumValue = z;
