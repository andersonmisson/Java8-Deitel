...
// Roa um dado de 6 lados 6.000.000 vezes

package br.com.java8.capitulo06.exemplo_06_07;
...
public class RolandoDado {
	...
	public static void main(String[] args) {
		// O abjeto randomNumbers produzirá números aleatórios seguros
		...
		System.out.println("FATE\tFrequency"); // cabeçalhos de saída
		System.out.printf("1\t%d%n2\t%d%n3\t%d%n4\t%d%n5\t%d%n6\t%d%n", frequency1, frequency3,frequency3,frequency4,frequency5,frequency6);
