package br.com.java8.capitulo06.exemplo_07_13;

// Figura 07.13: PassArray.java
...
public class PassArray {
	...
	public static void main(String[] args)
	{
		...
		// gera saida de elementos do arrya modificado
		for (int value: array)
			System.out.printf("    %d", value);
		...
		modifyElement(array[3]); // modifica o array[3]
		System.out.printf(
